...
String currentText = "Hello, Spacebrew";
...
void setup() {
  ...
  // connect!
  c.connet("ws://" + server + ":9000", name, description);
}
...
void draw() {
  ...
  textAlign(CENTER);
  textSize(14);
  text("Click the button to talk to Hello.", width / 2, height / 2 - 140);
...
void onRangeMessage(String name, int value) {
  printlnnn("got int message: " + name + " : " + value);
